...
(function () {
  ...
  function renderAllPages() {
    ...
    activePages.forEach((page, index) => {
      ...
      const isFinalPage = (index === activePages.length - 1);
      const finalPageSignatureHtml = isFinalPage ? `
          <div class="creator-imprint final-page-imprint" role="contentinfo" aria-label="Créé par MOUHIB MH">
            <div class="creator-ornament" aria-hidden="true">
              <svg viewBox="0 0 100 8" width="70" height="6" class="creator-ornament-svg">
                <line x1="0" y1="4" x2="38" y2="4" stroke="#d4af37" stroke-width="0.75" opacity="0.65" />
                <polygon points="50,1 53.5,4 50,7 46.5,4" fill="#d4af37" />
                <circle cx="42" cy="4" r="0.8" fill="#d4af37" opacity="0.8" />
                <circle cx="58" cy="4" r="0.8" fill="#d4af37" opacity="0.8" />
                <line x1="62" y1="4" x2="100" y2="4" stroke="#d4af37" stroke-width="0.75" opacity="0.65" />
              </svg>
            </div>
            <div class="creator-label">Créé par</div>
            <div class="creator-name">MOUHIB MH</div>
            <a href="https://www.instagram.com/mh_mouhib" target="_blank" rel="noopener noreferrer" class="creator-link" aria-label="Instagram @mh_mouhib">
              <svg class="creator-ig-icon" viewBox="0 0 24 24" width="11" height="11" fill="currentColor" aria-hidden="true">
